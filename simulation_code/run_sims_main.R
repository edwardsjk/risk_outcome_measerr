...
write.csv(results, file = paste0("output/server2500", scenario, "_", today, ".csv"))
...
write.csv(sc_res, file = paste0("output/tab2500_", today, "_", scenario, ".csv"))
