...
### Repeat sims with different shape function in validation dataset (nval = 2500) ###
...
write.csv(results, file = paste0("output/altval_server2500", scenario, "_", today, ".csv"))
...
write.csv(sc_res, file = paste0("output/altval_tab2500_", today, "_", scenario, ".csv"))
