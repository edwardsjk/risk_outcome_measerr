...
### Main sims with small validation dataset (nval = 200) ###
...
write.csv(results, file = paste0("output/server200", scenario, "_", today, ".csv"))
...
write.csv(sc_res, file = paste0("output/tab200_", today, "_", scenario, ".csv"))
